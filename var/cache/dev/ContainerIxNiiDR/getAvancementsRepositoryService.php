 ...
 */
class getAvancementsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AvancementsRepository' shared autowired service.
     *
     * @return \App\Repository\AvancementsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AvancementsRepository.php';

        return $container->privates['App\\Repository\\AvancementsRepository'] = new \App\Repository\AvancementsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
