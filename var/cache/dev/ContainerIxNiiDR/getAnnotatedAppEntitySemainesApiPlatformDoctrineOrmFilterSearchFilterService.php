 ...
 */
class getAnnotatedAppEntitySemainesApiPlatformDoctrineOrmFilterSearchFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_semaines_api_platform_doctrine_orm_filter_search_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['annotated_app_entity_semaines_api_platform_doctrine_orm_filter_search_filter'])) {
            return $container->privates['annotated_app_entity_semaines_api_platform_doctrine_orm_filter_search_filter'];
        }
        ...
        return $container->privates['annotated_app_entity_semaines_api_platform_doctrine_orm_filter_search_filter'] = new \ApiPlatform\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ($container->privates['logger'] ?? self::getLoggerService($container)), ['annees' => 'exact', 'mois' => 'exact', 'semaine' => 'exact'], $b, ($container->privates['api_platform.hydra.name_converter.hydra_prefix'] ?? self::getApiPlatform_Hydra_NameConverter_HydraPrefixService($container)));
    }
}
