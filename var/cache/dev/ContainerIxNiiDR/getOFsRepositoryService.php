 ...
 */
class getOFsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OFsRepository' shared autowired service.
     *
     * @return \App\Repository\OFsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OFsRepository.php';

        return $container->privates['App\\Repository\\OFsRepository'] = new \App\Repository\OFsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
